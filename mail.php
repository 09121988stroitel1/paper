...
$mail->addAddress('xa77azvgmail.com');     // Кому будет уходить письмо 
...
$mail->Subject = 'Заявка на бумагу';
$mail->Body    = '' .$name . ' оставил заявку, его телефон ' .$phone. '<br>Почта этого пользователя: ' .$email. '<br>Количество: ' .$quantity;
$mail->AltBody = '';
